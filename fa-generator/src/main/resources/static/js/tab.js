...
layui.define(["element", "common"], function (exports) {
  ...
  Tab.prototype.init = function () {
    ...
    if (typeof _config.elem !== "string" && typeof _config.elem !== "object") {
      common.throwError(
        "Tab error: elem参数未定义或设置出错，具体设置格式请参考文档API."
      );
    }
    var $container;
  ...
  Tab.prototype.tabAdd = function (data) {
    ...
    if (tabIndex === -1) {
      ...
      if (_config.maxSetting !== "undefined") {
        ...
        if (typeof _config.maxSetting === "object") {
          ...
          var msg =
            _config.maxSetting.tipMsg ||
            "为了系统的流畅度，只能同时打开" + max + "个选项卡。";
      ...
      //iframe 自适应
      ELEM.contentBox
        .find("iframe[data-id=" + globalTabIdIndex + "]")
        .each(function () {
      ...
      if (_config.closed) {
        ...
        ELEM.titleBox
          .find("li")
          .children("i.layui-tab-close[data-id=" + globalTabIdIndex + "]")
          .on("click", function () {
            element
              .tabDelete(ELEM.tabFilter, $(this).parent("li").attr("lay-id"))
              .init();
      ...
      if (_config.autoRefresh) {
        _config.elem
          .find("div.layui-tab-content > div")
          .eq(tabIndex)
          .children("iframe")[0]
    ...
    if (_config.contextMenu) {
      ...
      ELEM.titleBox.find("li").on("contextmenu", function (e) {
        ...
        var ul = "<ul>";
        ul +=
          '<li data-target="refresh" title="刷新当前选项卡"><i class="fa fa-refresh" aria-hidden="true"></i> 刷新</li>';
        ul +=
          '<li data-target="closeCurrent" title="关闭当前选项卡"><i class="fa fa-close" aria-hidden="true"></i> 关闭当前</li>';
        ul +=
          '<li data-target="closeOther" title="关闭其他选项卡"><i class="fa fa-window-close-o" aria-hidden="true"></i> 关闭其他</li>';
        ul +=
          '<li data-target="closeAll" title="关闭全部选项卡"><i class="fa fa-window-close-o" aria-hidden="true"></i> 全部关闭</li>';
        ul += "</ul>";
        div.innerHTML = ul;
          ...
          $context
            ...
            .each(function () {
              ...
              $that.on("click", function () {
                ...
                switch (target) {
                  case "refresh": //刷新当前
                    var src = ELEM.contentBox.find(
                      "iframe[data-id=" + id + "]"
                    )[0].src;
                    ELEM.contentBox.find("iframe[data-id=" + id + "]")[0].src =
                      src;
                    break;
