  ...
  (p.on = function (a, t, e) {
    ...
    (p.prototype.view = function () {
      ...
      if (
        ((t.pages = 0 | t.pages),
        (t.curr = 0 | t.curr || 1),
        (t.groups = "groups" in t ? 0 | t.groups : 5),
        (t.first = "first" in t ? t.first : "&#x9996;&#x9875;"),
        (t.last = "last" in t ? t.last : "&#x672B;&#x9875;"),
        ...
        return "";
      for (
        t.groups > t.pages && (t.groups = t.pages),
          r.index = Math.ceil(
            (t.curr + (t.groups > 1 && t.groups !== t.pages ? 1 : 0)) /
              (0 === t.groups ? 1 : t.groups)
          ),
          t.curr > 1 &&
            t.prev &&
            e.push(
          ...
          r.poor = Math.floor((t.groups - 1) / 2),
          r.start = r.index > 1 ? t.curr - r.poor : 1,
          r.end =
            r.index > 1
              ? (function () {
              ...
              : t.groups,
          r.end - r.start < t.groups - 1 && (r.start = r.end - t.groups + 1);
        r.start <= r.end;
        r.start++
      )
        r.start === t.curr
...
layui.define(function (e) {
  ...
  (t.laydate = function (e) {
    ...
    (n.run = function (e) {
      ...
      t &&
        ...
        ("init" in e ? e.init : a.init) &&
          !t[d.elemv] &&
          (t[d.elemv] = laydate.now(null, e.format || a.format)),
        n.view(t, e),
        n.reshow());
    }),
    (n.scroll = function (e) {
      return (
        (e = e ? "scrollLeft" : "scrollTop"), s.body[e] | s.documentElement[e]
      );
    }),
        ...
        e < n.mins[0]
          ...
          : e >= n.mins[0] &&
            ...
            (e == n.mins[0] &&
              (t < n.mins[1]
                ? (s = ["m"])
                : t == n.mins[1] && a < n.mins[2] && (s = ["d"])),
            e == n.maxs[0] &&
              (t > n.maxs[1]
                ? (s = ["m", 1])
                : t == n.maxs[1] && a > n.maxs[2] && (s = ["d", 1]))),
        s
      );
    }),
    ...
    (n.check = function () {
      var e = n.options.format
          .replace(/YYYY|MM|DD|hh|mm|ss/g, "\\d+\\")
          .replace(/\\$/g, ""),
        t = new RegExp(e),
        a = n.elem[d.elemv],
        s = a.match(/\d+/g) || [],
      ...
      if ("" !== a.replace(/\s/g, "")) {
        if (!t.test(a))
          return (
            (n.elem[d.elemv] = ""), n.msg("日期不符合格式，请重新选择。"), 1
          );
        if (i[0])
          return (
            (n.elem[d.elemv] = ""), n.msg("日期不在有效期内，请重新选择。"), 1
          );
        (i.value = n.elem[d.elemv].match(t).join()),
          ...
          s[1] < 1
            ...
            : s[1] > 12
            ? ((s[1] = 12), (i.auto = 1))
            : s[1].length < 2 && (i.auto = 1),
          s[2] < 1
            ? ((s[2] = 1), (i.auto = 1))
            : s[2] > n.months[(0 | s[1]) - 1]
            ? ((s[2] = 31), (i.auto = 1))
            : s[2].length < 2 && (i.auto = 1),
          s.length > 3 &&
            (n.timeVoid(s[3], 0) && (i.auto = 1),
            n.timeVoid(s[4], 1) && (i.auto = 1),
            n.timeVoid(s[5], 2) && (i.auto = 1)),
          i.auto
            ? n.creation([s[0], 0 | s[1], 0 | s[2]], 1)
            : i.value !== n.elem[d.elemv] && (n.elem[d.elemv] = i.value);
      }
    }),
    ...
    (n.viewDate = function (e, t, a) {
      ...
      e < (0 | n.mins[0]) && (e = 0 | n.mins[0]),
        ...
        n.each(new Array(3), function (e) {
          n.hmsin[e].value = n.digit(
            n.timeVoid(s.times[e], e) ? 0 | n.mins[e + 3] : 0 | s.times[e]
          );
        }),
    ...
    (n.orien = function (e, t) {
      ...
      (e.style.left = s.left + (t ? 0 : n.scroll(1)) + "px"),
        (a =
          s.bottom + e.offsetHeight / 1.5 <= n.winarea()
            ? s.bottom - 1
            : s.top > e.offsetHeight / 1.5
            ? s.top - e.offsetHeight + 1
            : n.winarea() - e.offsetHeight),
          ...
          : ((o = s[i]("div")),
            ...
            (o.innerHTML = r.html =
              ...
              (function () {
                var e = "";
                return (
                  n.each(new Array(12), function (t) {
    ...
    (n.reshow = function () {
      return (
        n.each(n.query("#" + d[0] + " .laydate_show"), function (e, t) {
      ...
      n.addClass(s.body, "laydate_body"),
        ...
        (a.tabYear = function (e) {
          0 === e
            ...
            : (a.YY += 14),
            e < 2
              ? (n.viewDate(n.ymd[0], n.ymd[1], n.ymd[2]), n.reshow())
              : n.viewYears(a.YY);
        }),
        ...
        (a.tabMonth = function (e) {
          e
            ? (n.ymd[1]++, 12 === n.ymd[1] && (n.ymd[0]++, (n.ymd[1] = 0)))
            : (n.ymd[1]--, n.ymd[1] === -1 && (n.ymd[0]--, (n.ymd[1] = 11))),
        ...
        n.each(e("#laydate_ms span"), function (e, t) {
          n.on(t, "click", function (e) {
            n.stopmp(e).reshow(),
              n.hasClass(this, d[1]) ||
                n.viewDate(n.ymd[0], 0 | this.getAttribute("m"), n.ymd[2]);
          });
        }),
        ...
        (n.msg = function (t, s) {
          ...
          "string" == typeof t
            ? ((i += "<p>" + t + "</p>"),
              n.shde(e("#" + d[0])),
              n
                .removeClass(a.times, "laydate_time1")
                .addClass(a.times, "laydate_msg"))
            : (a.hmsarr[t]
                ? (i = a.hmsarr[t])
                : ((i += '<div id="laydate_hmsno" class="laydate_hmsno">'),
          ...
          n.each(s, function (e, s) {
            i
              ...
              : n.on(s, "click", function (e) {
                  n.hasClass(this, d[1]) ||
                    (t.value = n.digit(0 | this.innerHTML));
                });
          }),
...
!(function (e, t) {
    ...
    r = {
      ...
      confirm: function (e, t, n, a) {
        ...
        return (
          l && ((a = n), (n = t)),
          r.open(
            i.extend({ content: e, btn: o.btn, yes: n, btn2: a }, l ? {} : t)
          )
        );
      },
      msg: function (e, n, a) {
  ...
  (s.anim = [
    ...
    (l.pt.auto = function (e) {
      ...
      "" === o.area[0] &&
        o.maxWidth > 0 &&
        (r.ie && r.ie < 8 && o.btn && l.width(l.innerWidth()),
    ...
    (l.pt.offset = function () {
      ...
      (e.offsetTop = (n.height() - a[1]) / 2),
        ...
        i.attr("minLeft") &&
          ((e.offsetTop = n.height() - (i.find(s[1]).outerHeight() || 0)),
    ...
    (l.pt.tips = function () {
      ...
      t.tips[1] || f.remove(),
        (l.autoLeft = function () {
          l.left + o[0] - n.width() > 0
            ? ((l.tipLeft = l.left + l.width - o[0]),
        ...
        l.where[c - 1](),
        1 === c
          ? l.top - (n.scrollTop() + o[1] + 16) < 0 && l.where[2]()
          : 2 === c
          ? n.width() - (l.left + l.width + o[0] + 16) > 0 || l.where[3]()
          : 3 === c
          ? l.top - n.scrollTop() + l.height + o[1] + 16 - n.height() > 0 &&
            l.where[0]()
          : 4 === c && o[0] + 16 - l.left > 0 && l.where[1](),
        a
          .find("." + s[5])
          .css({
      ...
      return (
        ...
        a
          ...
          .on("mouseup", function (e) {
            c.moveStart &&
              (delete c.moveStart, o.moveElem.hide(), t.moveEnd && t.moveEnd()),
          ...
          if (
            (n ||
              y.on("click", t.img, function () {
                ...
                r.photos(
                  i.extend(t, {
                    photos: { start: n, data: d, tab: t.tab },
                    full: t.full,
                  }),
                  !0
                ),
            ...
            if (!l.end) {
              ...
              e.preventDefault(),
                37 === t
                  ...
                  : 39 === t
                  ? l.imgnext(!0)
                  : 27 === t && r.close(l.index);
            }
          }),
          (l.tabimg = function (e) {
            d.length <= 1 ||
              ((f.start = l.imgIndex - 1),
              r.close(l.index),
              r.photos(t, !0, e));
          }),
          (l.event = function () {
...
layui.define("jquery", function (i) {
  ...
  (s.prototype.set = function (i) {
    ...
    (s.prototype.tabAdd = function (i, a) {
      ...
      return (
        l.append("<li>" + (a.title || "unnaming") + "</li>"),
    ...
    y = {
      tabClick: function (i, a, s) {
        ...
        o.addClass(l).siblings().removeClass(l),
          ...
          layui.event.call(this, e, "tab(" + u + ")", { elem: c, index: a });
      },
      tabDelete: function (i, a) {
        ...
        e.hasClass(l) &&
          (e.next()[0]
            ? y.tabClick.call(e.next()[0], null, n + 1)
            : e.prev()[0] && y.tabClick.call(e.prev()[0], null, n - 1)),
          e.remove(),
          o.eq(n).remove();
      },
      tabAuto: function () {
          ...
          b = function (o, c) {
            ...
            c.hasClass(u)
              ...
              : (y.addClass(f),
                ...
                clearTimeout(l),
                "block" === y.css("display") && clearTimeout(e),
                (e = setTimeout(function () {
      ...
      breadcrumb: function () {
        ...
        t(i).each(function () {
          ...
          e.find(".layui-box")[0] ||
            (e.each(function (i) {
              i !== e.length - 1 &&
                t(this).append('<span class="layui-box">' + a + "</span>");
            }),
      ...
      s.each(function (r, s) {
        ...
        t.unwrap ||
          (u =
            ...
            (s.attr("lay-title") || t.title || "上传" + (o[l] || "图片")) +
            "</span></div>"),
          (u = a(u)),
          t.unwrap ||
            u
        ...
        n = {
          select: function () {
            var e = "请选择",
              ...
              n = i(s).find("select"),
              u = function (e, n) {
                (i(e.target).parent().hasClass(t) && !n) ||
                  i("." + a).removeClass(a + "ed");
              },
              o = function (e, n) {
                var s = i(this),
                  o = e.find("." + t);
                n ||
                  ...
                  e.find("dl>dd").on("click", function () {
                    ...
                    return (
                      !e.hasClass(r) &&
                      (s.val(a).removeClass("layui-form-danger"),
                      o.find("input").val(e.text()),
                      e.addClass(c).siblings().removeClass(c),
                      void layui.event(l, "select(" + t + ")", {
                        elem: s[0],
                        value: a,
                      }))
                    );
                ...
                v = i(
                  [
                    '<div class="layui-unselect ' +
                      a +
                      (d ? " layui-select-disabled" : "") +
                      '">',
                    '<div class="' +
                      t +
                      '"><input type="text" placeholder="' +
                      (l.options[0].innerHTML ? l.options[0].innerHTML : e) +
                      '" value="' +
                      (f ? y.html() : "") +
            ...
            var e = {
              ...
              t = function (e, a) {
                ...
                e.on("click", function () {
                  ...
                  t[0].disabled ||
                    (t[0].checked
                      ? ((t[0].checked = !1), e.removeClass(a[1]))
                      : ((t[0].checked = !0), e.addClass(a[1])),
                    layui.event(l, a[2] + "(" + i + ")", {
                      elem: t[0],
                      value: t[0].value,
                    }));
              ...
              n = function (t) {
                ...
                t.on("click", function () {
                  ...
                  n[0].disabled ||
                    ...
                    (n[0].checked = !0),
                    t.addClass(e + "ed"),
                    t.find(".layui-icon").addClass(c).html(a[0]),
                    layui.event(l, "radio(" + o + ")", {
                      elem: n[0],
                      value: n[0].value,
                    }));
                });
  ...
  var o = function () {
      ...
      return (
        layui.each(f, function (e, l) {
          ...
          if (
            (s.removeClass(r),
            t[u] && (f ? (o = t[u](d, l)) : !t[u][0].test(d)))
          )
            return (
              a.msg(o || t[u][1], { icon: 5, shift: 6 }),
    ...
    (i.prototype.spread = function (e, o) {
      var a = this,
        ...
        l = function () {
          e.data("spread")
            ? (e.data("spread", null),
              i.removeClass("layui-show"),
              r.html(t.arrow[0]),
              n.find(".layui-icon").html(t.branch[0]))
            : (e.data("spread", !0),
              i.addClass("layui-show"),
              r.html(t.arrow[1]),
        ...
        i.drag &&
          o(document)
            ...
            .on("mouseup", function () {
              var e = a.move;
              e.from &&
                (e.from.elem.children("a").removeClass(r),
                e.to && e.to.elem.children("a").removeClass(r),
                (a.move = {}),
                o("." + t).remove());
            });
    }),
  ...
  var o = layui.jquery,
    i = {
      fixbar: function (l) {
        ...
        o(".layui-fixbar")[0] ||
          ("object" == typeof l.css && r.css(l.css),
          o("body").append(r),
          s(),
