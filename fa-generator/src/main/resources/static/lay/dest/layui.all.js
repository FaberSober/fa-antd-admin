    ...
    f = {
      tabClick: function (i, t, s) {
        ...
        o.addClass(e).siblings().removeClass(e),
          ...
          layui.event.call(this, l, "tab(" + u + ")", { elem: c, index: t });
      },
      tabDelete: function (i, t) {
        ...
        l.hasClass(e) &&
          (l.next()[0]
            ...
            : l.prev()[0] && f.tabClick.call(l.prev()[0], null, n - 1)),
          l.remove(),
          o.eq(n).remove(),
          setTimeout(function () {
            f.tabAuto();
      ...
      tabAuto: function () {
        ...
        a(".layui-tab").each(function () {
          ...
          if (
            (n === window && 8 != t.ie && f.hideTabMore(!0),
          ...
          t.find("." + r)[0] ||
            ...
            y.each(function () {
              ...
              i.off("click", f.clickThis).on("click", f.clickThis),
                i
                  .children("a")
                  .off("click", f.showChild)
                  .on("click", f.showChild),
                t
                  .children("dd")
                  .off("click", f.clickChild)
                  .on("click", f.clickChild);
            });
        });
      },
      breadcrumb: function () {
