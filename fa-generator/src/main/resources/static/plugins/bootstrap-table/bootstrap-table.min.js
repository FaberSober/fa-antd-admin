  ...
  (o.DEFAULTS = {
        ...
        : void (
            ...
            void 0 !== this.options.sortClass &&
              ...
              (g = setTimeout(function () {
                ...
                var a = b.$header.find(
                  c('[data-field="%s"]', b.options.sortName).index() + 1
                );
                b.$el
                  .find(c("tr td:nth-child(%s)", a))
          ...
          a.each(p, function (a, b) {
            if (
              ...
              (d = n
                ...
                : ""),
                r.push(
                  c('<li role="menuitem"%s><a href="#">%s</a></li>', d, b)
                );
            }
          }),
            r.push("</ul></span>"),
    ...
    (o.prototype.initRow = function (b, e) {
      ...
      if (!(a.inArray(b, this.hiddenRows) > -1)) {
        if (
          ((k = h(this.options, this.options.rowStyle, [b, e], k)), k && k.css)
        )
        ...
        return (
          ...
          a.each(this.header.fields, function (f, n) {
            ...
            if (
              !(
                (g.fromHtml && "undefined" == typeof p) ||
                !z.visible ||
                (g.options.cardView && !z.cardVisible)
              )
            ) {
              if (
                (z.escape && (p = j(p)),
                ...
                b["_" + n + "_class"] &&
                  (u = c(' class="%s"', b["_" + n + "_class"])),
                b["_" + n + "_rowspan"] &&
                  (w = c(' rowspan="%s"', b["_" + n + "_rowspan"])),
                b["_" + n + "_colspan"] &&
                  (x = c(' colspan="%s"', b["_" + n + "_colspan"])),
                b["_" + n + "_title"] &&
                  (y = c(' title="%s"', b["_" + n + "_title"])),
                ...
                z.checkbox || z.radio
                  ...
                  : ((q =
                      "undefined" == typeof q || null === q
                        ? g.options.undefinedText
                        : q),
                    (o = g.options.cardView
                      ? [
                          '<div class="card-view">',
                          g.options.showHeader
                            ? c(
                                '<span class="title" %s>%s</span>',
                                k,
                                d(g.columns, "field", "title", n)
                              )
                            : "",
                          c('<span class="value">%s</span>', q),
                          "</div>",
                        ].join("")
                      : [
                          c("<td%s %s %s %s %s %s %s>", t, u, k, v, w, x, y),
                          q,
                          "</td>",
                        ].join("")),
                    g.options.cardView &&
                      g.options.smartDisplay &&
                      "" === q &&
    ...
    (o.prototype.initBody = function (b) {
      ...
      this.trigger("pre-body", f),
        ...
        (this.options.pagination && "server" !== this.options.sidePagination) ||
          ((this.pageFrom = 1), (this.pageTo = f.length));
      for (
        var g, i = a(document.createDocumentFragment()), j = this.pageFrom - 1;
        j < this.pageTo;
        j++
      ) {
        var k = f[j],
          ...
          .on("click", function () {
            ...
            if (e.next().is("tr.detail-view"))
              b
                ...
                .attr(
                  "class",
                  c("%s %s", d.options.iconsPrefix, d.options.icons.detailOpen)
                ),
                d.trigger("collapse-row", g, i),
                e.next().remove();
            else {
              b
                .find("i")
                .attr(
                  "class",
                  c("%s %s", d.options.iconsPrefix, d.options.icons.detailClose)
                ),
                e.after(
                  c(
