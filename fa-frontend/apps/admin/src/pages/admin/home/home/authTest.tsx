...
import { ShiroPermissionContainer } from '@fa/ui';
  ...
  return (
    <div className="fa-full-content fa-bg-white fa-p12">
      ...
      <Card title="按钮权限控制-前台控制" className="fa-mb12">
        ...
        <Space>
          <ShiroPermissionContainer permission="/admin/home/home/authTest@button1">
            <Button onClick={test1} loading={loading1}>
              有权限
            </Button>
          </ShiroPermissionContainer>
          <ShiroPermissionContainer permission="/admin/home/home/authTest@button2">
