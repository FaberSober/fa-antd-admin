...
# Start
1. 下载如下插件，复制到plugins-zip目录中
    1. [elasticsearch-analysis-ik-7.17.7.zip](http://file.qiniu.test.dward.cn/fa/fa-core/docker/es/plugins/elasticsearch-analysis-ik-7.17.7.zip)
2. 启动docker服务
    ```
