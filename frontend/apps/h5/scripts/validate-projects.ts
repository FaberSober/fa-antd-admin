...
assert(
  defaultRegistry.featureIds.join(',') === 'fa-h5-base-pages,fa-h5-file-preview-pages,fa-h5-app-pages,fa-h5-demo-pages',
  'default 项目必须启用 base + file preview + APP download + demo Feature',
);
assert(
  demoRegistry.featureIds.join(',') === 'fa-h5-base-pages,fa-h5-file-preview-pages,fa-h5-app-pages,fa-h5-demo-pages',
