...
| `fa-h5-demo-pages` | H5 装配示例 | `fa-h5-base-pages` | 1 | active |
...
|---|---|---|---|
| `default` | FA H5 | `fa-h5-base-pages.home` | `fa-h5-base-pages`、`fa-h5-file-preview-pages` |
| `demo` | FA H5 Demo | `fa-h5-base-pages.home` | `fa-h5-base-pages`、`fa-h5-file-preview-pages`、`fa-h5-demo-pages` |
