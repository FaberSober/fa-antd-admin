...
|---|---|---|---:|---|
| `fa-h5-app-download-pages` | H5 APP 下载 | - | 2 | active |
...
|---|---|---|---|
| `default` | FA H5 | `fa-h5-base-pages.home` | `fa-h5-base-pages`、`fa-h5-file-preview-pages`、`fa-h5-app-download-pages`、`fa-h5-demo-pages` |
| `demo` | FA H5 Demo | `fa-h5-base-pages.home` | `fa-h5-base-pages`、`fa-h5-file-preview-pages`、`fa-h5-app-download-pages`、`fa-h5-demo-pages` |
...
| `default` | `fa-h5-app-download-pages.download` | `/app/:shortCode` | - |
| `default` | `fa-h5-app-download-pages.versions` | `/app/:shortCode/versions` | - |
...
| `demo` | `fa-h5-app-download-pages.download` | `/app/:shortCode` | - |
| `demo` | `fa-h5-app-download-pages.versions` | `/app/:shortCode/versions` | - |
