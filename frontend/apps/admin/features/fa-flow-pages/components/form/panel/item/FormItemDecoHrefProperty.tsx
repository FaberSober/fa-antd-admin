 ...
 */
export default function FormItemDecoHrefProperty() {
  return (
    <div>
      <Form.Item name="content" label="链接文本" rules={[{ required: true }]}>
        <Input placeholder="请输入链接文本" />
      </Form.Item>

      <Form.Item name="deco_href" label="链接地址" rules={[{ required: true }]}>
