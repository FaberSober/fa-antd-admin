 ...
 * neditor parse
 * version: 2.1.5
 * build: Tue Sep 18 2018 10:01:20 GMT+0000 (Coordinated Universal Time)
 */ !(function () {
  !(function () {
    UE = window.UE || {};
    var a = !!window.ActiveXObject,
      b = {
        ...
        extend: function (a, b) {
          for (
            var c = arguments, d = !!this.isBoolean(c[c.length - 1]) && c[c.length - 1], e = this.isBoolean(c[c.length - 1]) ? c.length - 1 : c.length, f = 1;
            f < e;
            f++
          ) {
            var g = c[f];
    ...
    UE.parse.register('list', function (a) {
          ...
          if (b.className && /custom_/i.test(b.className)) {
            ...
            if ('dash' == f || 'dot' == f)
              a.pushItem(c, h + ' li.list-' + d[f] + '{background-image:url(' + e.liiconpath + d[f] + '.gif)}'),
                a.pushItem(
                  c,
                  h + ' ul.custom_' + f + '{list-style:none;} ' + h + ' ul.custom_' + f + ' li{background-position:0 3px;background-repeat:no-repeat}'
                );
            else {
              var g = 1;
              a.each(b.childNodes, function (b) {
                ...
                a.pushItem(
                  c,
                  h + ' ol.custom_' + f + '{list-style:none;}' + h + ' ol.custom_' + f + ' li{background-position:0 3px;background-repeat:no-repeat}'
                );
            }
            switch (f) {
              case 'cn':
      ...
      a.extend(this, { liiconpath: a.removeLastbs(this.rootPath) + '/themes/ueditor-list/', listDefaultPaddingLeft: '20' });
      var e = this.root,
      ...
      f.length && b.call(this, f),
        ...
        (f.length || g.length) &&
          ...
          a.cssRule('list', h + ' ol,' + h + ' ul{margin:0;padding:0;}\n' + h + ' li{clear:both;}\n' + c.join('\n'), document));
    }),
