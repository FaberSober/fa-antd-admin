/*! Video.js v4.3.0 Copyright 2013 Brightcove, Inc. https://github.com/videojs/video.js/blob/master/LICENSE */ (function () {
  ...
  u.gc = function (a, c) {
    var d = u.getData(a);
    0 === d.z[c].length &&
      (delete d.z[c], document.removeEventListener ? a.removeEventListener(c, d.W, l) : document.detachEvent && a.detachEvent('on' + c, d.W));
  ...
  t.e = function () {
    ...
    if (!c || this.m.movingMediaElementInDOM === l)
      c ? ((d = c.cloneNode(l)), u.l.jc(c), (c = d), (a.M = h)) : (c = u.e('video', { id: a.id() + '_html5_api', className: 'vjs-tech' })),
        (c.player = a),
        u.zb(c, a.w());
