...
(function () {
      ...
      d = function (a, b) {
        ...
        for (h in b)
          b.hasOwnProperty(h) &&
            ((c = b[h]),
            (a[h] =
              c && typeof c === 'object' && Object.prototype.toString.call(c) !== '[object Array]' && typeof c.nodeType !== 'number'
                ? d(a[h] || {}, c)
                : b[h]));
        return a;
      };
          ...
          if (e !== '' || m.length === 1) {
            ...
            if (
              ...
              !o &&
                ...
                v(n, 'dy', l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, gb && n.offsetHeight)),
              b.appendChild(n),
              o++,
              k)
            )
                    ...
                    ? ((e = E),
                      ...
                      e.length &&
                        ...
                        p && B * w > p
                          ...
                          : ((n = y.createElementNS(za, 'tspan')), v(n, { dy: w, x: i }), s && v(n, 'style', s), b.appendChild(n), t > k && (k = t))))
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        g === 'radialGradient' &&
          b &&
          !u(c.gradientUnits) &&
          (c = x(c, { cx: b[0] - b[2] / 2 + c.cx * b[2], cy: b[1] - b[2] / 2 + c.cy * b[2], r: c.r * b[2], gradientUnits: 'userSpaceOnUse' }));
  ...
  if (!Z && !$) {
    Highcharts.VMLElement = F = {
      ...
      setSpanRotation: function (a, b, c) {
        K(this.element, {
          filter: a
            ? ['progid:DXImageTransform.Microsoft.Matrix(M11=', c, ', M12=', -b, ', M21=', b, ', M22=', c, ", sizingMethod='auto expand')"].join('')
            : S,
        });
      },
    ...
    render: function (a, b, c) {
      ...
      if (m && s)
        t === 'inside' && (s = -s),
          ...
          p ? p.animate({ d: b, opacity: c }) : (this.mark = f.path(b).attr({ stroke: u, 'stroke-width': m, opacity: c }).add(d.axisGroup));
      if (i && !isNaN(H))
        (i.xy = E = this.getLabelPosition(H, E, i, g, k, x, a, r)),
          (this.isFirst && !this.isLast && !o(e.showFirstLabel, 1)) || (this.isLast && !this.isFirst && !o(e.showLastLabel, 1))
            ? (v = !1)
    ...
    setOffset: function (a, b) {
      ...
      if ((e = this.label))
        e.align(this.alignOptions, null, f),
          (f = e.alignAttr),
          e.attr({ visibility: this.options.crop === !1 || d.isInsidePlot(f.x, f.y) ? (Z ? 'inherit' : 'visible') : 'hidden' });
    },
  };
  db.prototype = {
    defaultOptions: {
    ...
    translate: function (a, b, c, d, e, f) {
      ...
      b
        ...
        : (e && (a = this.val2lin(a)), f === 'between' && (f = 0.5), (a = h * (a - d) * j + i + h * k + (sa(f) ? j * f * this.pointRange : 0)));
      return a;
    },
    ...
    render: function () {
      ...
      if (o)
        (A = a.getLinePath(o)),
          a.axisLine ? a.axisLine.animate({ d: A }) : (a.axisLine = c.path(A).attr({ stroke: d.lineColor, 'stroke-width': o, zIndex: 7 }).add(a.axisGroup)),
  ...
  xb.prototype = {
    ...
    onContainerTouchStart: function (a) {
      var b = this.chart;
      a.touches.length === 1
        ? ((a = this.normalize(a)), b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) ? (this.runPointActions(a), this.pinch(a)) : this.reset())
      ...
      if (b)
        (c = b.translateY),
          n(this.allItems, function (e) {
            ...
            f &&
              ((g = c + f.y + (a || 0) + 3),
              K(f, { left: b.translateX + e.legendItemWidth + f.x - 20 + 'px', top: g + 'px', display: g > c - 6 && g < c + d - 6 ? '' : S }));
          });
    },
  ...
  yb.prototype = {
    ...
    showLoading: function (a) {
      var b = this.options,
        ...
        d = b.loading;
      if (!c)
        (this.loadingDiv = c = U(Ea, { className: 'highcharts-loading' }, r(d.style, { zIndex: 10, display: S }), this.container)),
    ...
    drawChartBox: function () {
      ...
      if (m)
        g
          ...
          : (this.plotBorder = b.rect(q, o, n, s, 0, -m).attr({ stroke: a.plotBorderColor, 'stroke-width': m, zIndex: 1 }).add());
      this.isDirtyBox = !1;
    },
  ...
  Q.prototype = {
    ...
    setStackedPoints: function () {
      if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
        ...
        for (o = 0; o < d; o++) {
          ...
          e === 'percent'
            ? ((p = p ? h : i), j && l[p] && l[p][n] ? ((p = l[p][n]), (q.total = p.total = s(p.total, q.total) + N(t) || 0)) : (q.total += N(t) || 0))
            : (q.total += t || 0);
          q.cum = (q.cum || 0) + (t || 0);
      ...
      if (d && (f || g)) {
        ...
        if (b.inverted)
          (a.height = k.y = b.plotWidth - d),
            c.isVML &&
              ((a = { x: b.plotWidth - d - b.plotLeft, y: 0, width: e, height: j }), (k = { x: d + b.plotLeft - e, y: 0, width: b.plotLeft + d, height: e }));
    ...
    setState: function (a) {
      ...
      if (this.state !== a)
        (this.state = a),
          (e[a] && e[a].enabled === !1) || (a && (b = e[a].lineWidth || b + 1), c && !c.dashstyle && ((a = { 'stroke-width': b }), c.attr(a), d && d.attr(a)));
    },
              ...
              n(this.points, function (b) {
                ...
                if ((r = b.dataLabel) && r._pos)
                  (E = r._attr.visibility),
                    ...
                    (z = r.connY),
                    (j = k
                      ? ['M', y + (v[6] === 'left' ? 5 : -5), z, 'C', y, z, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], 'L', v[4], v[5]]
