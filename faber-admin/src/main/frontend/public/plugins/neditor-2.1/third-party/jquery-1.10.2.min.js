...
(function (e, t) {
  ...
  x.fn.extend({
    ...
    (X = {
      set: function (e, t, n) {
        return (
          t === !1 ? x.removeAttr(e, n) : (K && Q) || !G.test(n) ? e.setAttribute((!Q && x.propFix[n]) || n, n) : (e[x.camelCase('default-' + n)] = e[n] = !0),
          n
        );
      },
    }),
  ...
  x.each(['height', 'width'], function (e, n) {
    ...
    x.expr &&
      ...
      ((x.expr.filters.hidden = function (e) {
        return (
          (0 >= e.offsetWidth && 0 >= e.offsetHeight) || (!x.support.reliableHiddenOffsets && 'none' === ((e.style && e.style.display) || x.css(e, 'display')))
        );
      }),
    ...
    x.extend({
      ...
      ajax: function (e, n) {
        ...
        (l = p.global),
          ...
          p.ifModified &&
            (x.lastModified[o] && C.setRequestHeader('If-Modified-Since', x.lastModified[o]), x.etag[o] && C.setRequestHeader('If-None-Match', x.etag[o])),
        ...
        function k(e, n, r, i) {
          ...
          2 !== b &&
            ...
            c
              ? (p.ifModified &&
                  ((T = C.getResponseHeader('Last-Modified')), T && (x.lastModified[o] = T), (T = C.getResponseHeader('etag')), T && (x.etag[o] = T)),
