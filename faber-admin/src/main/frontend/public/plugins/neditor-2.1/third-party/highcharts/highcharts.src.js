  ...
  Tick.prototype = {
    ...
    addLabel: function () {
      var tick = this,
        ...
        width =
          (horiz && categories && !labelOptions.step && !labelOptions.staggerLines && !labelOptions.rotation && chart.plotWidth / tickPositions.length) ||
  ...
  Axis.prototype = {
    ...
    translate: function (val, backwards, cvsCoord, old, handleLog, pointPlacement) {
      ...
      if (backwards) {
        ...
        returnValue =
          sign * (val - localMin) * localA + cvsOffset + sign * minPixelPadding + (isNumber(pointPlacement) ? localA * pointPlacement * axis.pointRange : 0);
      }
