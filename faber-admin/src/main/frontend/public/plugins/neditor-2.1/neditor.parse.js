 ...
 * neditor parse
 * version: 2.1.5
 * build: Tue Sep 18 2018 10:01:17 GMT+0000 (Coordinated Universal Time)
 */
      ...
      utils.each(nodes, function (list) {
        if (list.className && /custom_/i.test(list.className)) {
          ...
          if (listStyle == 'dash' || listStyle == 'dot') {
            utils.pushItem(
              customCss,
              selector + ' li.list-' + customStyle[listStyle] + '{background-image:url(' + T.liiconpath + customStyle[listStyle] + '.gif)}'
            );
            utils.pushItem(
              customCss,
              selector +
