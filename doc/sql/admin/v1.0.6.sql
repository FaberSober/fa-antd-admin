/*
 ...
 Source Schema         : faber_admin_1.6.0_20221211

 Target Server Type    : MySQL
 Target Server Version : 50734
 File Encoding         : 65001

 Date: 11/12/2022 22:35:20
*/
...
-- ----------------------------
-- Table structure for base_config_col
-- ----------------------------
DROP TABLE IF EXISTS `base_config_col`;
CREATE TABLE `base_config_col`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 21 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'BASE-配置-表格字段' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_config_scene`  (
  ...
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 23 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'BASE-配置-查询场景' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_log_api`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17018 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'BASE-URL请求日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `base_log_login`  (
  ...
  `deleted` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 306 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'BASE-登录日志' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `demo_student` VALUES (1, 'xx11', NULL, NULL, NULL, NULL, 1, '[{\"name\": \"新生\"}, {\"name\": \"一年级\"}]', '{\"info1\": \"hello\", \"info2\": \"world\"}', NULL, 1, '2022-12-09 11:24:55', '1', 'admin', '127.0.0.1', '2022-12-09 10:05:46', NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (2, 'xx12', NULL, NULL, NULL, NULL, 1, '[{\"name\": \"新生\"}, {\"name\": \"二年级\"}]', '{\"info1\": \"hello\", \"info2\": \"bar\"}', NULL, 1, '2022-12-09 11:24:53', '1', 'admin', '127.0.0.1', '2022-12-09 10:05:46', NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (9, 'custom_name', 19, NULL, 'xxx@mail.com', NULL, 1, '[]', NULL, 8, 1, '2022-12-09 09:58:52', '1', 'admin', '127.0.0.1', '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (10, 'custom_name', 19, NULL, 'xxx@mail.com', NULL, 1, NULL, NULL, 9, 1, '2022-09-16 11:18:06', '1', 'admin', '127.0.0.1', '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (11, 'custom_name', 19, NULL, 'xxx@mail.com', NULL, 1, NULL, NULL, 10, 1, '2022-09-16 11:18:38', '1', 'admin', '127.0.0.1', '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (12, 'custom_name', 19, NULL, 'xxx@mail.com', NULL, 1, NULL, NULL, 11, 1, '2022-12-02 09:35:58', '1', 'admin', NULL, '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (13, 'custom_name', 19, 2, 'xxx@mail.com', '2022-12-05', 0, NULL, NULL, 12, 1, '2022-09-16 13:36:18', '1', 'admin', '127.0.0.1', '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (14, 'custom_name', 19, 0, 'xxx@mail.com', '2022-11-29', 0, NULL, NULL, NULL, 1, '2022-09-16 15:36:55', '1', 'admin', '127.0.0.1', '2022-09-18 19:21:38', '1', 'admin', '127.0.0.1', 0);
INSERT INTO `demo_student` VALUES (15, '张三', 19, 1, '123@qq.com', '2022-11-30', 0, NULL, NULL, NULL, 1, '2022-09-18 20:29:24', '1', 'admin', '127.0.0.1', '2022-11-30 22:13:40', '1', '超级管理员', '192.168.58.1', 0);
INSERT INTO `demo_student` VALUES (16, '李四', 21, 1, 'lisi@qq.com', '1989-02-08', 1, NULL, NULL, NULL, 1, '2022-12-01 11:49:53', '1', '超级管理员', '127.0.0.1', '2022-12-01 11:49:53', '1', '超级管理员', '61.242.134.93', 1);
INSERT INTO `demo_student` VALUES (17, 'xx', 11, 1, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:51:20', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (18, 'xx', 3, 1, 'xx@xx.com', '2022-11-29', 1, NULL, NULL, NULL, 1, '2022-12-05 14:51:29', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (19, 'xx', 33, 2, 'xx@xx.com', '2022-11-30', 1, NULL, NULL, NULL, 1, '2022-12-05 14:51:38', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (20, 'xx', 11, 1, 'xx@xx.com', '2022-11-29', 1, NULL, NULL, NULL, 1, '2022-12-05 14:51:51', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (21, 'xx', 33, 2, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:01', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (22, 'xx', 33, 0, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:11', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (23, 'xx', 22, 0, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:20', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (24, 'xx', 33, 0, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:29', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (25, 'xx', 33, 1, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:38', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (26, 'xx', 33, 1, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:52:48', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (27, 'xx', 11, 1, 'xx@xx.com', '2022-11-28', 1, NULL, NULL, NULL, 1, '2022-12-05 14:53:17', '1', '超级管理员', '127.0.0.1', NULL, NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (28, 'xx', 11, 0, 'xx@xx.com', '2022-11-28', 1, '[{\"name\": \"新生\"}, {\"name\": \"二年级\"}]', '{\"info1\": \"hello\", \"info2\": \"bar\"}', NULL, 1, '2022-12-05 14:53:25', '1', '超级管理员', '127.0.0.1', '2022-12-09 16:52:30', NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (29, 'xx', 11, 0, 'xx@xx.com', '2022-11-28', 1, '[{\"name\": \"新生\"}, {\"name\": \"一年级\"}]', '{\"info1\": \"hello\", \"info2\": \"world\"}', NULL, 1, '2022-12-05 14:53:34', '1', '超级管理员', '127.0.0.1', '2022-12-09 16:52:30', NULL, NULL, NULL, 0);
INSERT INTO `demo_student` VALUES (30, 'xx123啊', 11, 0, 'xx@xx.com', '2022-11-30', 1, NULL, NULL, NULL, 1, '2022-12-08 11:14:22', '1', '超级管理员', '127.0.0.1', '2022-12-08 11:14:22', '1', '超级管理员', '127.0.0.1', 1);
...
-- ----------------------------
INSERT INTO `demo_student_info` VALUES (1, '字段1', '字段2');
INSERT INTO `demo_student_info` VALUES (2, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (3, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (4, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (5, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (6, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (7, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (8, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (9, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (10, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (11, 'info111', 'info222');
INSERT INTO `demo_student_info` VALUES (12, 'info111', 'info222');
...
-- ----------------------------
INSERT INTO `demo_tree` VALUES (55, 0, 'leaf1', 0, '2022-11-30 18:41:03', '1', '超级管理员', '127.0.0.1', '2022-11-30 18:43:35', '1', '超级管理员', '127.0.0.1', 0);
INSERT INTO `demo_tree` VALUES (56, 55, 'leaf1-1', 0, '2022-11-30 18:43:44', '1', '超级管理员', '127.0.0.1', '2022-11-30 21:50:39', '1', '超级管理员', '221.231.192.204', 0);
INSERT INTO `demo_tree` VALUES (57, 0, 'leaf2', 1, '2022-11-30 21:50:45', '1', '超级管理员', '221.231.192.204', '2022-12-04 18:35:19', '1', '超级管理员', '192.168.58.1', 0);
INSERT INTO `demo_tree` VALUES (58, 55, 'leaf3', 0, '2022-12-04 20:14:04', '1', '超级管理员', '221.231.192.204', '2022-12-04 20:14:05', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (59, 56, 'leaf1-1-1', 0, '2022-12-04 20:14:15', '1', '超级管理员', '221.231.192.204', '2022-12-04 20:14:16', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (60, 57, 'leaf2-1', 0, '2022-12-04 20:14:20', '1', '超级管理员', '221.231.192.204', '2022-12-04 20:14:21', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (61, 59, 'leaf1-1-1-1', 0, '2022-12-04 20:14:12', '1', '超级管理员', '127.0.0.1', '2022-12-04 20:14:13', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (62, 59, 'leaf1-1-1-2', 1, '2022-12-04 20:14:09', '1', '超级管理员', '127.0.0.1', '2022-12-04 20:14:10', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (63, 61, '智慧结算银行导入-确认取消驳回权限', 0, '2022-12-04 18:35:36', '1', '超级管理员', '61.242.134.93', '2022-12-04 18:35:37', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (64, 0, 'leaf001', 0, '2022-12-04 11:18:17', '1', '超级管理员', '192.168.58.1', '2022-12-04 11:18:17', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (65, 0, 'aaa', 0, '2022-12-04 11:18:56', '1', '超级管理员', '192.168.58.1', '2022-12-04 11:18:56', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (66, 55, 'leaf1-2', 1, '2022-12-04 20:42:13', '1', '超级管理员', '192.168.58.1', '2022-12-04 20:44:11', '1', '超级管理员', '192.168.58.1', 0);
INSERT INTO `demo_tree` VALUES (67, 55, 'leaf1-3', 2, '2022-12-04 20:47:00', '1', '超级管理员', '192.168.58.1', '2022-12-04 20:49:46', '1', '超级管理员', '192.168.58.1', 0);
INSERT INTO `demo_tree` VALUES (68, 55, 'leaf1-4', 4, '2022-12-04 21:05:10', '1', '超级管理员', '192.168.58.1', '2022-12-04 21:05:11', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (69, 55, 'leaf1-5', 5, '2022-12-04 21:05:08', '1', '超级管理员', '192.168.58.1', '2022-12-04 21:05:09', '1', '超级管理员', '192.168.58.1', 1);
INSERT INTO `demo_tree` VALUES (70, 55, 'leaf1-6', 6, '2022-12-04 21:05:05', '1', '超级管理员', '192.168.58.1', '2022-12-04 21:05:06', '1', '超级管理员', '192.168.58.1', 1);
